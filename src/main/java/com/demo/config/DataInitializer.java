...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Listing loft = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 4, 1, 9, 0))
                .owner(admin2)
                .city(City.MADRID)
                .isActive(true)
        ...
        Listing ap = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 4, 5, 11, 30))
                .owner(admin2)
                .isActive(true)
                .city(City.ALICANTE)
        ...
        Listing ap2 = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 4, 12, 16, 0))
                .owner(userExtra)
                .city(City.ASTURIAS)
                .isActive(true)
                .type(ListingType.APARTAMENTO)
        ...
        Listing cf = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 4, 18, 10, 15))
                .owner(guest2)
                .city(City.SEVILLA)
                .isActive(true)
        ...
        Listing hp = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 4, 25, 14, 0))
                .owner(guest2)
                .city(City.VALENCIA)
                .isActive(true)
        ...
        Listing vi = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 5, 3, 9, 30))
                .owner(userExtra)
                .city(City.BARCELONA)
                .isActive(true)
        ...
        Listing cha = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 5, 8, 17, 45))
                .owner(userExtra)
                .city(City.BILBAO)
                .isActive(false)
        ...
        Listing estudio = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 5, 15, 11, 0))
                .owner(admin2)
                .city(City.GRANADA)
                .isActive(true)
                .type(ListingType.APARTAMENTO)
        ...
        Listing casaRural = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 5, 22, 8, 30))
                .owner(userExtra)
                .city(City.GRANADA)
                .isActive(true)
                .type(ListingType.CASA)
        ...
        Listing atico = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 5, 28, 15, 20))
                .owner(admin2)
                .city(City.GRANADA)
                .isActive(true)
                .type(ListingType.APARTAMENTO)
        ...
        Listing bungalow = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 6, 5, 10, 0))
                .owner(userExtra)
                .city(City.ALICANTE)
                .isActive(true)
                .type(ListingType.CHALET)
        ...
        Listing loftCentrico = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 6, 12, 13, 45))
                .owner(admin2)
                .city(City.BILBAO)
                .isActive(true)
                .type(ListingType.LOFT)
        ...
        Listing villaAndaluza = Listing.builder()
                ...
                .registeredAt(LocalDateTime.of(2026, 6, 19, 9, 15))
                .owner(userExtra)
                .city(City.GRANADA)
                .isActive(true)
                .type(ListingType.VILLA)
